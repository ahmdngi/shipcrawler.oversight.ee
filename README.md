...
- **Interactive Global Map** — Theatre of operations with vessel tracking markers
...
- **Map:** D3.js military-style world map with zoom/pan
...
- [Hermes Agent](https://hermes-agent.nousresearch.com) — The AI agent that built this
